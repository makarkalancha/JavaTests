package com.everything.javafx.border_pane.example2;
...
public class Main extends Application {
    ...
    public void start(Stage stage) {
         ...
         */
        BorderSlideBar topFlapBar = new BorderSlideBar(Color.RED, 100, buttonTop, Pos.TOP_LEFT, labelTop);
        borderPane.setTop(topFlapBar);

        BorderSlideBar leftFlapBar = new BorderSlideBar(Color.GREEN, 300, buttonLeft, Pos.BASELINE_LEFT, labelLeft);
        borderPane.setLeft(leftFlapBar);

        BorderSlideBar bottomFlapBar = new BorderSlideBar(Color.BLUE, 100, buttonBottom, Pos.BOTTOM_LEFT, labelBottom);
        borderPane.setBottom(bottomFlapBar);

        BorderSlideBar rightFlapBar = new BorderSlideBar(Color.YELLOW, 100, buttonRight, Pos.BASELINE_RIGHT, labelRight);
