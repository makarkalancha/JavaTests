...
//        String[] stringArray = {"A", "a", "b", "c", "d"};
        String[] stringArray = {"Clone-Sync Emails", "Bulk Import", "Bugs", "Invalid atrkid", "My Jiras", "!Favorite", "Team 6", "JBoss", "Jenkins", "Log", "Management", "Oracle", "Oracle DB", "Setup", "Ticket"};
