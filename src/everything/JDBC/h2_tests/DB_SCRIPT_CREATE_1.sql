...
CREATE SEQUENCE FINANCE1.SEQ_FAMILY_MEMBER;
CREATE TABLE FINANCE1.FAMILY_MEMBER(
ID BIGINT DEFAULT FINANCE1.SEQ_FAMILY_MEMBER.NEXTVAL PRIMARY KEY,
NAME VARCHAR(65),
...
CREATE SEQUENCE FINANCE1.SEQ_CURRENCY;
CREATE TABLE FINANCE1.CURRENCY(
ID BIGINT DEFAULT FINANCE1.SEQ_CURRENCY.NEXTVAL PRIMARY KEY,
...
CREATE SEQUENCE FINANCE1.SEQ_ACCOUNT_GROUP;
--@Entity
...
ID BIGINT DEFAULT FINANCE1.SEQ_ACCOUNT_GROUP.NEXTVAL,
...
CREATE SEQUENCE FINANCE1.SEQ_ACCOUNT;
--@Entity
--@Inheritance(strategy = InheritanceType.SINGLE_TABLE)
...
ID BIGINT DEFAULT FINANCE1.SEQ_ACCOUNT.NEXTVAL PRIMARY KEY,
...
CREATE SEQUENCE FINANCE1.SEQ_CATEGORY_GROUP;
--@Entity
--@Inheritance(strategy = InheritanceType.SINGLE_TABLE)
--@DiscriminatorColumn(name = "TYPE", discriminatorType = DiscriminatorType.CHAR, length = 1)
CREATE TABLE FINANCE1.CATEGORY_GROUP(
ID BIGINT DEFAULT FINANCE1.SEQ_CATEGORY_GROUP.NEXTVAL,
...
CREATE SEQUENCE FINANCE1.SEQ_CATEGORY;
--@Entity
--@Inheritance(strategy = InheritanceType.SINGLE_TABLE)
...
ID BIGINT DEFAULT FINANCE1.SEQ_CATEGORY.NEXTVAL PRIMARY KEY,
...
CREATE SEQUENCE FINANCE1.SEQ_ORGANIZATION;
CREATE TABLE FINANCE1.ORGANIZATION(
ID BIGINT DEFAULT FINANCE1.SEQ_ORGANIZATION.NEXTVAL PRIMARY KEY,
NAME VARCHAR(65) NOT NULL,
DESCRIPTION VARCHAR(1024),
T_CREATEDON TIMESTAMP,
T_UPDATEDON TIMESTAMP AS NOW()
...
CREATE SEQUENCE FINANCE1.SEQ_TAX;
...
ID BIGINT DEFAULT FINANCE1.SEQ_TAX.NEXTVAL PRIMARY KEY,
...
CREATE SEQUENCE FINANCE1.SEQ_TAX_RATE;
...
ID BIGINT DEFAULT FINANCE1.SEQ_TAX_RATE.NEXTVAL PRIMARY KEY,
TAX_ID BIGINT,
...
CREATE SEQUENCE FINANCE1.SEQ_INVOICE;
CREATE TABLE FINANCE1.INVOICE(
ID BIGINT DEFAULT FINANCE1.SEQ_INVOICE.NEXTVAL PRIMARY KEY,
...
CREATE SEQUENCE FINANCE1.SEQ_ITEM;
CREATE TABLE FINANCE1.ITEM(
ID BIGINT DEFAULT FINANCE1.SEQ_ITEM.NEXTVAL PRIMARY KEY,
INVOICE_ID BIGINT,
CATEGORY_ID BIGINT,
TAX_ID BIGINT,
