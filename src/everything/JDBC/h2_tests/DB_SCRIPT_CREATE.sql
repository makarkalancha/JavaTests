...
CREATE SEQUENCE FINANCE.SEQ_FAMILY_MEMBER;
CREATE TABLE FINANCE.FAMILY_MEMBER(
ID BIGINT DEFAULT FINANCE.SEQ_FAMILY_MEMBER.NEXTVAL PRIMARY KEY,
NAME VARCHAR(65),
...
CREATE SEQUENCE FINANCE.SEQ_CURRENCY;
CREATE TABLE FINANCE.CURRENCY(
ID BIGINT DEFAULT FINANCE.SEQ_CURRENCY.NEXTVAL PRIMARY KEY,
...
CREATE SEQUENCE FINANCE.SEQ_ACCOUNT_GROUP;
--@Entity
...
ID BIGINT DEFAULT FINANCE.SEQ_ACCOUNT_GROUP.NEXTVAL,
...
CREATE TABLE FINANCE.BILL_COIN_AMT(
...
CREATE SEQUENCE FINANCE.SEQ_CATEGORY_GROUP;
--@Entity
--@Inheritance(strategy = InheritanceType.SINGLE_TABLE)
--@DiscriminatorColumn(name = "TYPE", discriminatorType = DiscriminatorType.CHAR, length = 1)
CREATE TABLE FINANCE.CATEGORY_GROUP(
ID BIGINT DEFAULT FINANCE.SEQ_CATEGORY_GROUP.NEXTVAL,
...
CREATE SEQUENCE FINANCE.SEQ_CATEGORY;
--@Entity
--@Inheritance(strategy = InheritanceType.SINGLE_TABLE)
...
ID BIGINT DEFAULT FINANCE.SEQ_CATEGORY.NEXTVAL PRIMARY KEY,
...
CREATE SEQUENCE FINANCE.SEQ_ORGANIZATION;
CREATE TABLE FINANCE.ORGANIZATION(
ID BIGINT DEFAULT FINANCE.SEQ_ORGANIZATION.NEXTVAL PRIMARY KEY,
NAME VARCHAR(65) NOT NULL,
DESCRIPTION VARCHAR(1024),
T_CREATEDON TIMESTAMP,
T_UPDATEDON TIMESTAMP AS NOW(),
...
CREATE SEQUENCE FINANCE.SEQ_TAX;
...
ID BIGINT DEFAULT FINANCE.SEQ_TAX.NEXTVAL PRIMARY KEY,
...
CREATE SEQUENCE FINANCE.SEQ_TAX_RATE;
...
ID BIGINT DEFAULT FINANCE.SEQ_TAX_RATE.NEXTVAL PRIMARY KEY,
TAX_ID BIGINT,
...
CREATE SEQUENCE FINANCE.SEQ_INVOICE;
CREATE TABLE FINANCE.INVOICE(
ID BIGINT DEFAULT FINANCE.SEQ_INVOICE.NEXTVAL PRIMARY KEY,
...
CREATE SEQUENCE FINANCE.SEQ_ITEM;
CREATE TABLE FINANCE.ITEM(
ID BIGINT DEFAULT FINANCE.SEQ_ITEM.NEXTVAL PRIMARY KEY,
INVOICE_ID BIGINT,
CATEGORY_ID BIGINT,
TAX_ID BIGINT,
...
CREATE TABLE FINANCE.CURRENCY_RATE(
