...
INSERT INTO FINANCE1.TRANSACTION (ACCOUNT_ID, INVOICE_ID, DATE, DEBIT_AMOUNT, CREDIT_AMOUNT, COMMENT) VALUES(@cash_cad,@inv1,'2016-02-03',@inv1_balance,DEFAULT,'trans comm');
...
INSERT INTO FINANCE1.TRANSACTION (ACCOUNT_ID, INVOICE_ID, DATE, DEBIT_AMOUNT, CREDIT_AMOUNT, COMMENT) VALUES(@visa_1234_cad,@inv2,'2016-02-02',@inv2_balance,DEFAULT,'trans comm');
...
INSERT INTO FINANCE1.TRANSACTION (ACCOUNT_ID, INVOICE_ID, DATE, DEBIT_AMOUNT, CREDIT_AMOUNT, COMMENT) VALUES(@cash_cad,@inv3,'2016-02-02',DEFAULT,@inv3_balance,'transfer from cash to visa');
INSERT INTO FINANCE1.TRANSACTION (ACCOUNT_ID, INVOICE_ID, DATE, DEBIT_AMOUNT, CREDIT_AMOUNT, COMMENT) VALUES(@visa_1234_cad,@inv3,'2016-02-02',DEFAULT,@inv3_balance,'transfer from cash to visa');
